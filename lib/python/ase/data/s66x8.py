##########################################################
#                                                        #
##  This module wraps data for the S66X8 set (Hobza)    ##
#                                                        #
...
def get_interaction_energy_CC_s66x8(name_system):
    """
...
def get_interaction_energy_PBE_MBD_s66x8(name_system):
    """
    return interaction energy for S66X8 dimer <name_system>
...
def get_interaction_energy_PBE_TS_s66x8(name_system):
    """
    return interaction energy for S66X8 dimer <name_system>
